<?php
/*---------------------------------------------------------------------
 * * APPLICATION : Centre d'Appels
 * * SOUS-SYSTEME: PFA
 * * MODULE      : WEB CL
 * * Fichier     : $Id: lib_debug.php,v 1.3 2011/07/12 12:49:42 nguyen Exp $
 * * Création    : 27/10/04
 * * Auteur      : $Author: nguyen $
 * *------------------------------------------------------------------
 * * Historique  :
 * * date     auteur          résumé
 * * $Log: lib_debug.php,v $
 * * Revision 1.3  2011/07/12 12:49:42  nguyen
 * * *** empty log message ***
 * *
 * * Revision 1.2  2010/12/29 08:43:31  nguyen
 * * *** empty log message ***
 * *
 * * Revision 1.1  2010/08/20 13:47:39  nguyen
 * * *** empty log message ***
 * *
 * * Revision 1.1  2009/01/20 08:58:32  gtdev
 * * Ajout des Kits de développement (PHP, DOTNET). Le kit JAVA reste à intégrer (sources).
 * *
 * * Revision 1.1.1.1  2005/08/02 08:16:44  nnguyen
 * * - version initiale issue de la PFA CL
 * *
 * * Revision 1.2  2004/10/27 09:53:20  nnn
 * * - ajout d'entete
 * *
 * *
 *
...
if ( !defined('__LIB_DEBUG_PHP') )
{
	...
	************************************************/
	...
	class Print_a_class {
		...
		var $output;
		var $iterations;
		var $key_bg_color = '13eaea';//'a6c835';//'e98f9d';//'98cd13';//'1E32C8';
		...
		function print_a($array, $iteration = FALSE, $key_bg_color = FALSE) {
			...
			$this->output .= '<table style="border:none;" cellspacing="0">';
	...
	function print_result($RESULT) {
		...
		print '<table bgcolor="#000000" cellspacing="0" cellpadding="0">';
